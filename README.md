...
Current version: 0.3.2. The Yahoo gateway is deployed at https://wealth-pocket-quotes.solomonwei-pocket.workers.dev. Version is shown in Settings and the footer. Reload the existing Home Screen app to update; no reinstall or quote keys are needed. Local portfolio storage is preserved.
