...
try {
 ...
 await page.locator('#mobile-nav [data-tab=settings]').click();await page.locator('#fx-form [name=USD]').fill('30');await page.locator('#fx-form button').click();assert.equal(await page.evaluate(()=>JSON.parse(localStorage.getItem('pocket-assets-v1')).fx.USD),30);
